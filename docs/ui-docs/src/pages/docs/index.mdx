...
![Picture27](../../assets/pic27.png)

The homepage shows your current project, as well as all the flows within.

The list of available actions with the project:

- Rename your project and change its description
- Open Chatsky code for this bot
...
Editor is the main workspace of Chatsky UI. This is where you create a graph, build and run the bot, test it, and eventually launch it in messengers.

<Callout type="default">
  All the editor components will be further explained down below
</Callout>

### Project menu

![Picture25](../../assets/pic25.png)
...
<Callout type="info">
  Account settings will be added with an upcoming release.
</Callout>

### Tabs

![Picture21](../../assets/pic21.png)

The bottom panel is the navigation within Chatsky UI.

The left mouse button with Chatsky UI logo leads to the homepage.
The left mouse button with Chatsky UI logo leads to the homepage.
...
Import tab allows you to upload or create dialog samples, assign flows and convert them into the first draft of your graph.
...
*[Read more about build & run.](../docs/deliver.mdx)*
...
*[Read more about Inspect.](../docs/inspect.mdx)*

### Settings

![Picture22](../../assets/pic22.png)

Settings tab allows you to configure general settings, as well as the pipeline, build & run and advanced settings.

*[Read more about Settings.](../docs/settings.mdx)*

### Library

![Picture24](../../assets/pic24.png)
...
*[Read more about Library.](../docs/library.mdx)*

### Notifications

![Picture23](../../assets/pic23.png)
