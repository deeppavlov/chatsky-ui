...
from chatsky_ui.services.json_converter_new2.logic_component_converter.condition_converter import (
    CustomConditionConverter, SlotConditionConverter, BadConditionException
)
from chatsky_ui.services.json_converter_new2.logic_component_converter.response_converter import (
    TextResponseConverter, CustomResponseConverter, BadResponseException
)
...
class TestConditionConverter:
    ...
    def test_slot_condition_converter(self, slot_condition, slots_conf):
        ...
        assert converted_cnd == {
            "chatsky.conditions.slots.SlotsExtracted": "test_slot"
        }
    ...
    def test_slot_condition_converter_get_pre_transitions(self, slot_condition, slots_conf):
        ...
        assert converter.get_pre_transitions() == {
            "test_slot": {
