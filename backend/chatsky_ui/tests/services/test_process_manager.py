...
class TestRunManager:
    ...
    async def test_start(self, mocker, preset, run_manager):  # noqa: F811
        ...
        run_process = mocker.patch("chatsky_ui.services.process_manager.RunProcess")
        ...
        run_process_instance.start.assert_awaited_once_with(f"chatsky_ui run_bot {BUILD_ID} --preset {preset.end_status}")
