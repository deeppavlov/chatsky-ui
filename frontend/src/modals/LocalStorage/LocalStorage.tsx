...
const LocalStorage = ({
  ...
  return (
    ...
    <Modal
      className={'min-h-[208px] w-min px-0 py-0'}
      isOpen={isOpen}
      onClose={onClose}
    >
      <ModalHeader className='flex flex-initial px-6 py-4 text-large font-semibold'>
        Local Storage
      </ModalHeader>
      <ModalBody className='flex flex-1 flex-col gap-3 px-6 py-2'>
        ...
        >
          ...
          <Tab
            key={'Slot snippets'}
            title={
              <span className='flex items-center gap-2'>Slot snippets</span>
            }
          >
            Coming soon...
          </Tab>
      ...
      <ModalFooter className={'flex flex-row justify-end gap-2 px-6 py-4'}>
        {''}
      </ModalFooter>
    </Modal>
  )
