...
const ListViewIcon = ({stroke='var(--foreground)'}: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      ...
      />
      <path
        d='M5 7C5 7.55229 5.44772 8 6 8C6.55228 8 7 7.55229 7 7C7 6.44771 6.55228 6 6 6C5.44772 6 5 6.44771 5 7Z'
        fill={stroke}
      />
      <path
        d='M5.00057 17C5.00057 17.5523 5.44828 18 6.00057 18C6.55285 18 7.00057 17.5523 7.00057 17C7.00057 16.4477 6.55285 16 6.00057 16C5.44828 16 5.00057 16.4477 5.00057 17Z'
        fill={stroke}
      />
    </svg>
  )
