...
const LinkNode = memo(({ data }: { data: LinkNodeDataType }) => {
  ...
  const handleFlowSelectionChange = (
  ...
  return (
    <>
      ...
      >
        <div className='flex h-1/3 w-full items-center justify-between rounded-node bg-node'>
          <Handle
            isConnectableEnd
          ...
          <Popover radius='sm'>
            <PopoverTrigger>
              <p className='text-medium font-medium text-neutral-500'>
                {data.name}
              </p>
            </PopoverTrigger>
        ...
        <div className='flex h-2/3 items-start justify-between py-2.5'>
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow className='w-full' key={1}>
